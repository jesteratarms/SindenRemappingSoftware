...
default_options += [(chr(i), str(i - 87)) for i in range(97, 123)] #lower case letters
default_options += [(chr(i), str(i - 23)) for i in range(65, 91)] #Upper Case letters
default_options += [("Return", "704")]
